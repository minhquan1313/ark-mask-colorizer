import { ARK_PALETTE } from './arkPalette.js';

export const idToEntry = (id) => ARK_PALETTE.find((p) => String(p.index) === String(id)) || null;

export function toVariantColorId(slotValue) {
  if (slotValue == null) {
    return null;
  }
...
export function buildVariantKey(entry, slots) {
...
export function buildSlotsColorSignature(slots) {
